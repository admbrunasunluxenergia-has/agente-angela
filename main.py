...
CLICKUP_LIST_ID_ATENDIMENTO = os.getenv("CLICKUP_LIST_ID_ATENDIMENTO")
CLICKUP_LIST_ID_VENDAS = os.getenv("CLICKUP_LIST_ID_VENDAS")
...
def log_to_postgres(phone: str, sender: str, message: str):
    ...
    try:
        ...
        cur = conn.cursor()
        # Tabela: CREATE TABLE conversation_logs (id SERIAL PRIMARY KEY, phone_number VARCHAR(20), sender VARCHAR(10), message TEXT, timestamp TIMESTAMPTZ DEFAULT NOW());
        cur.execute(
